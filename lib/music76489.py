...
class Music76489:
    ...
    def __init__(self):
        ...
        self._sn76489_we = Pin(13) #K: Pin A4 digital assignment, same as digitalio.DigitalInOut(board.pin)
        self._sn76489_we = Pin(13, Pin.OUT) #K: Pin A4 digital OUTPUT assignment, same as .direction = digitalio.Direction.OUTPUT
